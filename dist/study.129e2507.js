const dict = document.querySelector(".main"), word_search = dict.querySelector("input"), text_info = dict.querySelector(".info_text"), synonyms = dict.querySelector(".synonyms .list"), closeDict = dict.querySelector(".search span");
